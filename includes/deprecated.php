...
function stream_query( $args = array() ) {
	_deprecated_function( __FUNCTION__, '1.2.4', 'wp_stream_query()' );
...
function get_stream_meta( $record_id, $key = '', $single = false ) {
	_deprecated_function( __FUNCTION__, '1.2.4', 'wp_stream_get_meta()' );
...
function update_stream_meta( $record_id, $meta_key, $meta_value, $prev_value = '' ) {
	_deprecated_function( __FUNCTION__, '1.2.4', 'wp_stream_update_meta()' );
...
function existing_records( $column, $table = '' ) {
	_deprecated_function( __FUNCTION__, '1.2.4', 'wp_stream_existing_records()' );
