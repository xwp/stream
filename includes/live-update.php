...
class WP_Stream_Live_Update {
	...
	public static function heartbeat_received( $response, $data ) {
		...
		$total_items = self::$list_table->_pagination_args['total_items'];
		$total_pages = self::$list_table->_pagination_args['total_pages'];
		$per_page    = self::$list_table->_pagination_args['per_page'];
