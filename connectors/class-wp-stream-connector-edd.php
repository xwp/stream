...
class WP_Stream_Connector_EDD extends WP_Stream_Connector {
	...
	public static function get_context_labels() {
		return array(
			'download'          => __( 'Downloads', 'edd', 'stream' ),
			'download_category' => __( 'Categories', 'edd', 'stream' ),
			'download_tag'      => __( 'Tags', 'edd', 'stream' ),
			'edd_discount'      => __( 'Discounts', 'edd', 'stream' ),
			'reports'           => __( 'Reports', 'edd', 'stream' ),
			'api_keys'          => __( 'API Keys', 'edd', 'stream' ),
			//'payments'        => __( 'Payments', 'edd', 'stream' ),
		);
	}
