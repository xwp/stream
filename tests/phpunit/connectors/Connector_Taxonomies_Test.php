...
class Connector_Taxonomies_Test extends WP_StreamTestCase {
	/**
	...
	public function test_callback_created_term() {
		...
		$this->mock->expects( $this->once() )
			...
			->with(
				...
				$this->callback( array( self::class, 'assert_created_term_context' ) ),
				$this->greaterThan( 0 ),
	...
	/**
	 * Assert created-term log context values (term_id is assigned at create time).
	 *
	 * @param mixed $context Log context argument.
	 * @return bool
	 */
	public static function assert_created_term_context( $context ): bool {
		return is_array( $context )
			&& isset( $context['term_name'], $context['taxonomy_label'], $context['term_id'], $context['taxonomy'], $context['term_parent'] )
			&& 'test' === $context['term_name']
			&& 'category' === $context['taxonomy_label']
			&& 'category' === $context['taxonomy']
			&& 0 === $context['term_parent']
			&& is_int( $context['term_id'] )
			&& $context['term_id'] > 0
			&& 5 === count( $context );
	}
