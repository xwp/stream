...
class Connector_EDD_Test extends WP_StreamTestCase {
	...
	public function test_check_add_option() {
	...
	public function test_check_update_option() {
		edd_update_option( 'thousands_separator', '.' );
	...
	public function test_check_delete_option() {
		edd_update_option( 'thousands_separator', ',' );
	...
	public function test_settings_transport_import() {
		$this->mock->expects( $this->once() )
			->method( 'log' )
			->with(
	...
	public function test_settings_transport_export() {
		$this->mock->expects( $this->once() )
			->method( 'log' )
			->with(
