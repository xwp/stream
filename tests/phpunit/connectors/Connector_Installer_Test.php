...
class Connector_Installer_Test extends WP_StreamTestCase {
	...
	public function test_callback_upgrader_process_complete_theme_update() {
		$this->markTestSkipped( 'This test skipped until the needed scenario can be properly simulated.' );
	...
	public function test_callback__core_updated_successfully_auto() {
		$this->markTestSkipped( 'This test skipped until the needed scenario can be properly simulated.' );
